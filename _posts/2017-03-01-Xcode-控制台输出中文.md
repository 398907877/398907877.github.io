...
创建一个字典并输出:
    ...
    NSDictionary *dic = @{@"name"  : @"BY",
                           @"My bolg" : @"http://398907877.github.io",
                           @"count" : @(11),
                           @"strData" : strData,
                           @"dicData" : dicData,
                           @"set"     : set,
                           @"Unicode" : @"😀😁🤣😂😄",
                           @"contact" : @[@"BY Blog:http://398907877.github.io",
                                          @"GitHub:https://github.com/wujiajun",
...
输出结果：
	...
	2017-03-01 10:36:45.709 BYFoundationLog_Demo[1657:53604] {
	    ...
	    contact =     (
	        "BY Blog:http://398907877.github.io",
	        "GitHub:https://github.com/wujiajun",
...
代码及Demo地址：[GitHub](https://github.com/wujiajun/BYFoundationLog)
